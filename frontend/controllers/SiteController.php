...
class SiteController extends \yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $result['SKF']['describe']  = '自1907年以来， SKF作为领先的技术供应商，具有不断研发新技术的强大实力，为客户提供具有竞争力的优势产品。SKF集团总部设立于瑞典哥德堡，是商品科技与制造的领导者、世界最大的商品生产商，SKF商品产量占全球同类产品总产量的20%。。如今SKF技术研发的重点是在运营中减少资产生命周期对环境的影响。';
        ...
        $result['FAG']['describe']  = '1883年，FAG在德国施魏因福特成立，是舍弗勒集团旗下品牌。一流的质量、优秀的技术和卓越的创新精神构成了舍弗勒持续成功的基础。通过提供广泛应用于工业领域的滚动商品和滑动商品解决方案，舍弗勒集团正积极实现“高效驱动，驰骋未来”（Mobility for tomorrow）的战略目标。';
        ...
        $result['NSK']['describe']  = 'NSK自1916年在日本率先开始生产商品以来，作为日本的商品先锋，开发与提供各类商品，为产业的发展和机械的进步做出了巨大贡献。现在，NSK在商品领域，稳居日本首位，同时在全世界也位居前列。今后，NSK还将一如既往地尽快将中国客户需求反映到产品上，并且以满足客户为己任，超越自己，超越未来。';
        ...
        $result['FYH']['describe']  = 'FYH株式会社自1950年在日本首次生产PILLOW BLOCK（带座滚动商品）以来，已逐步成长为支撑世界产业发展的带座滚动商品专业厂家。FYH生产的商品的最后公差要比日本工业品规格标准还要严格，FYH商品可以在高速旋转等各种要求严格的场所使用，得到了用户的好评。';
